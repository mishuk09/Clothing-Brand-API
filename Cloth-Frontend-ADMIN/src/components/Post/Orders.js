...
const Orders = () => {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            try {
                ...
                const response = await axios.get('https://mishuk09-clothing-brand-api-backend.onrender.com/item/orders', {
                    headers: {
    ...
    const handleCompleteOrder = async (orderId) => {
        try {
            ...
            await axios.delete(`https://mishuk09-clothing-brand-api-backend.onrender.com/item/orders/${orderId}`, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
