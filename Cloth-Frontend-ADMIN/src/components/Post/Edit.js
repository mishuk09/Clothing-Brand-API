...
const Edit = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get('https://mishuk09-clothing-brand-api-backend.onrender.com/edit', {
                    headers: {
    ...
    useEffect(() => {
        axios.get('https://mishuk09-clothing-brand-api-backend.onrender.com/posts/')
            .then(response => {
